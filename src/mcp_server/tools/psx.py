...
def fetch_psx_summary() -> dict:
    """Fetch the PSX snapshot (reusable outside the MCP tool, e.g. the scheduler
    pre-check). Returns {"error": ...} if the data couldn't be read."""
    import httpx
